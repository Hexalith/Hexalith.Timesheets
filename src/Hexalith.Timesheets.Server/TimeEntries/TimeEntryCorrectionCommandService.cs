...
/// <summary>
/// Composes the fail-closed gates for correcting a rejected Time Entry.
/// <para>
...
/// their own rejected entry must still obtain provider/policy authority and fails closed when
/// none is available. No ad hoc role checks are performed here. Both the current rejected-entry
